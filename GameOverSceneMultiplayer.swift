...
class GameOverSceneMutiplayer: SKScene {
    ...
    init(size: CGSize, score1:Int, score2:Int) {
        ...
        let message1 = score1 >= score2 ? "You Won! :D" : "You Lose :["
        let message2 = score2 >= score1 ? "You Won! :D" : "You Lose :["
        ...
        label1.position = CGPoint(x: size.width * 0.1, y: size.height/2)
        addChild(label1)
        
        let labelScore1 = SKLabelNode(fontNamed: "Chalkduster")
        labelScore1.text = "Your score: \(score1)"
        labelScore1.fontSize = 30
        labelScore1.fontColor = SKColor.black
        labelScore1.position = CGPoint(x: size.width * 0.1, y: size.height/2-45)
        ...
        labelScore2.text = "Your score: \(score2)"
